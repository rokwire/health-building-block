    ...
    "paths": {
        ...
        "/admin/rosters/phone/{phone}": {
            "delete": {
                ...
                "operationId": "DeleteRosterByPhone",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Phone",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/updateRosterRequest"
                        }
                    },
                    {
                        "type": "string",
